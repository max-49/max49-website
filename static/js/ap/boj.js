...
;
if (drupalSettings.cb.widget_profile.enabled) {
  this.cb = this.cb || {};
  cb.core = cb.core || {};
  cb.core.utils = cb.core.utils || {};
  cb.core.utils.DeploymentProfile = {
    iam: {
      appId: drupalSettings.cb.widget_profile.app_id,
      requiresLogin: drupalSettings.cb.widget_profile.requires_login,
      sessionCheck: drupalSettings.cb.widget_profile.session_check
    },
    dataProtector: {
      protectionEnabled: drupalSettings.cb.widget_profile.levity_protection
    }
  };

  if (drupalSettings.cb.widget_profile.aws_domains) {
    cb.core.utils.DeploymentProfile.iam.aws = {
      cbAWSDomains: drupalSettings.cb.widget_profile.aws_domains
    };
  }
}
;